...
?>
    ...
    <div class="container-fluid">
        ...
        <div class="col-md-5 activity-col">
            <div class="col-title">Choose committee to work with</div>
            <div class="create-box">
                <p class="add-info">Decision making could be tasking, choose friends as committee to deliberate and decide your entire event</p>
                <form class="add-committee">
                    <div class="form-group">
                        <div class="add-box-details"><div class="pull-left">You added</div><div class="pull-right">2 / 21 <a href=""><i class="fa fa-plus-square"></i></a></div></div>
                        <input type="text" title="event_name" placeholder="@username" class="form-control" name="event_name">
                    </div>
                    <div class="form-group">
                        <button type="submit" class="btn btn-block btn-primary">Add listed friends</button>
                        </div>
            ...
            <div class="row save-btn-container">
                ...
                <div class="col-xs-6 save-btn continue-btn">
                    <button class="btn btn-default btn-block"><div class="text-danger">No thanks <i class="fa fa-arrow-right"></i></div> </button>
                </div>
            </div>
            </form>
